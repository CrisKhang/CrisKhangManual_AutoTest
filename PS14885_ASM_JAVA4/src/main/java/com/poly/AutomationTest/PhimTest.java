...
public class PhimTest {
	...
	private final String SRC = ExcelUtils.DATA_SRC + "PhimDataTest.xlsx";
	...
	public void setUp() {
		...
		webDriver.get("http://localhost:8080/PS14885_ASM_JAVA4/manager/index");
		log = new PhimData();
	}

	private void processPhim(String maPhim, String tiTle, String noiDung, String doPhanGiai, String daoDien,
		...
		WebElement maphimInput = webDriver.findElement(By.xpath("/html/body/div[2]/form/div[1]/input"));
		maphimInput.sendKeys(maPhim);
	...
	public void multiplePhim(String maPhim, String tiTle, String noiDung, String doPhanGiai, String daoDien,
		...
		processPhim(maPhim, tiTle, noiDung, doPhanGiai, daoDien, ngayCongChieu, thoiLuong, phuDe, traiLer, link, poster, hinh1, hinh2, hinh3, hinh4, hieuLuc);
