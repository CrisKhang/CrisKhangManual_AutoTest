...
//		YÃªu thÃ­ch
	...
	private void doFavorite(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.sendRedirect("/PS14885_ASM_JAVA4/page/detail/" + id);
	}
	...
	private void doShare(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String from = "sevennguyen34@gmail.com";
		String to = req.getParameter("To");
		String content = req.getParameter("Content");
		String body = "Bạn <b>" + nguoiDung.getHo() + " " + nguoiDung.getTen() + "</b> đã chia sẽ phim <b>"
				+ phim.getTitle() + "</b> trang web http://localhost:8080/PS14885_ASM_JAVA4/index. Chúc bạn xem phim vui vẻ!"
				+ "<br> <a href=\"http://localhost:8080/PS14885_ASM_JAVA4/page/detail/" + id + "\">Link phim</a>"
		...
		Session session = Session.getInstance(props, new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				// TODO Auto-generated method stub
				String userName = "sevennguyen34@gmail.com";
				String passWord = "quokjljqgzavxcto";
		...
		// resp.sendRedirect("/PS14885_ASM_JAVA4/page/detail/share/" + id);
		doGet(req, resp);
		// req.getRequestDispatcher("/views/detail.jsp").forward(req, resp);
	}
}
