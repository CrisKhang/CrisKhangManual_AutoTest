...
body {
	color: rgb(0, 0, 0);
	background: url(/PS14885_ASM_JAVA4/image/background.png);
...
<body>
	...
	<div class="signup-form">
		...
		<div class="text-center">
			Bạn chưa có tài khoản? <a href="/PS14885_ASM_JAVA4/register">Đăng ký</a>
		</div>
		<div class="text-center">
			Trở về <a href="/PS14885_ASM_JAVA4/index">trang chủ</a>
		</div>
	</div>
</body>