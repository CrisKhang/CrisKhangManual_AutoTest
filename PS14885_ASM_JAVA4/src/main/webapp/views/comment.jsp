	...
	<div class="container card">
		<ul class="list-unstyled">
			 <c:forEach var="item" items="${listBL}">
				...
				src="/PS14885_ASM_JAVA4/image/johndoe.png" width="70" height="70"
		...
		<ul class="pagination justify-content-center" id="page">
			<li class="page-item ${disBack?'disabled':''}"><button formaction="/PS14885_ASM_JAVA4/page/detail/back/${idFilm}" id="prev" class="page-link"
				href="#"><i class="fas fa-angle-double-left"></i></button></li>
			<li class="page-item ${disNext?'disabled':''}"><button formaction="/PS14885_ASM_JAVA4/page/detail/next/${idFilm}" id="next" class="page-link"><i
