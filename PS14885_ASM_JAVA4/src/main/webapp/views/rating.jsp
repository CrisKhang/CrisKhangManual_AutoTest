                    ...
                    <div class="btn-1">
                     	<c:choose>
                     		<c:when test="${!editRate}">
                     			<button class="click" onclick="check(false)" formaction="/PS14885_ASM_JAVA4/page/detail/rating/${idFilm}" type="submit">Gửi</button>
                     		</c:when>
                     		<c:otherwise>
                     			<button class="click" onclick="check(false)" formaction="/PS14885_ASM_JAVA4/page/detail/editRating/${idFilm}" type="submit">Gửi</button>
                     		</c:otherwise>
                     	</c:choose>
