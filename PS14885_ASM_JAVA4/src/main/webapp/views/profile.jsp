...
<body>
    ...
    <!-- Tag Profile -->
    <form action="/PS14885_ASM_JAVA4/page/profile" method="post" enctype="multipart/form-data">
    <div class="container rounded bg-white mt-5 mb-5">
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5"
                        src="/PS14885_ASM_JAVA4/img/user.png" width="90"><span class="font-weight-bold">${profile.getTenDN()}</span><span
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" formaction="/PS14885_ASM_JAVA4/page/profile/update">Cập
                            nhật</button></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="p-3 py-5">
                    ...
                    <div class="d-flex flex-row mt-3 exp-container"><img src="/PS14885_ASM_JAVA4/image/heart.png" width="45" height="45"
                            height="45">
                    ...
                    <hr>
                    <div class="d-flex flex-row mt-3 exp-container"><img src="/PS14885_ASM_JAVA4/image/speech-bubble.png" width="45"
                            height="45">
    ...
    <footer>
        <div class="container-fluid w-100 text-center" style="color: white; height: 100px; background-color: grey;">
            ...
            <h5>&copy; Copyright by annddps14885@fpt.edu.vn</h5>
        </div>
    </footer>
    <!-- Tag Footer -->
    ...
    <!-- Link Javascript -->
    <script type="text/javascript" src="/PS14885_ASM_JAVA4/js/javascript.js"></script>
    <script type="text/javascript" src="/PS14885_ASM_JAVA4/js/detail.js"></script>
    <script type="text/javascript" src="/PS14885_ASM_JAVA4/js/profile.js"></script>
