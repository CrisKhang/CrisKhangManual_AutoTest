...
<body>
	...
	<div class="container pt-4">
		<a href="/PS14885_ASM_JAVA4/page/item/1" class="btn btn-outline-info btn-block">Xem
			thêm</a>
	</div>
	<!-- Tag Xem thêm -->
	...
	<div class="container pt-4 pb-4">
		<a href="/PS14885_ASM_JAVA4/page/item/0" class="btn btn-outline-info btn-block">Xem
			thêm</a>
	</div>
	<!-- Tag Xem thêm -->
	...
	<footer>
		<div class="container-fluid w-100 text-center"
			...
			<h5>&copy; Copyright by anndps14885@fpt.edu.vn</h5>
		</div>
	</footer>
	<!-- Tag Footer -->
	...
	<script type="text/javascript" src="/PS14885_ASM_JAVA4/js/script.js"></script>
	<!-- Link Javascript -->
