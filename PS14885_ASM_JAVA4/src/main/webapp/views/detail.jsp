...
<body data-spy="scroll" data-target="#click1" data-offset="50"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form action="/PS14885_ASM_JAVA4/page/detail" method="post">
            ...
            <div class="modal-footer">
              ...
              <button class="btn btn-primary" formaction="/PS14885_ASM_JAVA4/page/detail/share/${idFilm}">Gửi</button>
            </div>
            </form>
          </div>
        </div>
	...
	<script type="text/javascript" src="/PS14885_ASM_JAVA4/js/rating.js"></script>
	<script>
