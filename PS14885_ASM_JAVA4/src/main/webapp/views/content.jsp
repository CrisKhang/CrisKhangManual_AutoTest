				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
							<div class="tab-pane active">
								<img id="pic-1" src="/PS14885_ASM_JAVA4/fileImg1/${phim.getPoster()}" />
							</div>
						</div>
						<ul class="preview-thumbnail nav nav-tabs">
							<li class="active"><a data-target="#pic-1" data-toggle="tab"
								onclick="Choose(1)"><img
									src="/PS14885_ASM_JAVA4/fileImg1/${phim.getPoster()}" id="img1" /></a></li>
							<li><a data-target="#pic-2" data-toggle="tab"
								onclick="Choose(2)"><img
									src="/PS14885_ASM_JAVA4/fileImg1/${phim.getHinh1()}" id="img2" /></a></li>
							<li><a data-target="#pic-3" data-toggle="tab"
								onclick="Choose(3)"><img
									src="/PS14885_ASM_JAVA4/fileImg1/${phim.getHinh2()}" id="img3" /></a></li>
							<li><a data-target="#pic-4" data-toggle="tab"
								onclick="Choose(4)"><img
									src="/PS14885_ASM_JAVA4/fileImg1/${phim.getHinh3()}" id="img4" /></a></li>
							<li><a data-target="#pic-5" data-toggle="tab"
								onclick="Choose(5)"><img
									src="/PS14885_ASM_JAVA4/fileImg1/${phim.getHinh4()}" id="img5" /></a></li>
						</ul>
					...
					<div class="details col-md-6">
						...
						<div class="action">
							...
							<c:if test="${check}">
								<button class="like btn btn-default" formaction="/PS14885_ASM_JAVA4/page/detail/favorite/${idFilm}">
									<span class="fa fa-heart"></span>
								</button>
							</c:if>
