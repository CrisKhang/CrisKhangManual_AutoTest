		...
		<form class="pb-4" action="${u}/index" method="post"
			...
			<div class="form-group">
			    ...
			    <c:if test="${!empty edit}">
			       <img src="/PS14885_ASM_JAVA4/fileImg1/${phim.getPoster()}" width="200" height="200">
			...
			<div class="form-group">
				...
				<c:if test="${!empty edit}">
			       <img src="/PS14885_ASM_JAVA4/fileImg1/${phim.getHinh1()}" width="200" height="200">
			...
			<div class="form-group">
				...
				<c:if test="${!empty edit}">
			       <img src="/PS14885_ASM_JAVA4/fileImg1/${phim.getHinh2()}" width="200" height="200">
			...
			<div class="form-group">
				...
				<c:if test="${!empty edit}">
			       <img src="/PS14885_ASM_JAVA4/fileImg1/${phim.getHinh3()}" width="200" height="200">
			...
			<div class="form-group">
				...
				<c:if test="${!empty edit}">
			       <img src="/PS14885_ASM_JAVA4/fileImg1/${phim.getHinh4()}" width="200" height="200">
